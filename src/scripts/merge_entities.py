...
from src.schema.entity import (
    EntityCollection, Disease, Gene, Drug, Protein, 
    Symptom, Procedure, Biomarker, Pathway
)
...
def main():
    ...
    if len(sys.argv) < 3:
        print("Usage: python merge_entities_manual.py <output_file> <input_file1> [input_file2] ...")
        print("Example: python merge_entities_manual.py reference_entities_complete.jsonl reference_entities.jsonl hgnc_genes.jsonl")
        sys.exit(1)
